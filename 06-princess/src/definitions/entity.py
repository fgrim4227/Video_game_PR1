...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    "player": {
        ...
        "animations": {
            ...
            "bow-left": {"frames": [3], "texture": "character-bow"},
            "bow-right": {"frames": [2], "texture": "character-bow"},
            "bow-down": {"frames": [1], "texture": "character-bow"},
            "bow-up": {"frames": [4], "texture": "character-bow"},
        },
    },
    "skeleton": {
        "texture": "entities",
